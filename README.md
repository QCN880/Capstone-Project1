 ...
 - #### Questions
  ...
  - #### Exploratory Analysis using pivot tables
    ...
    - Pivot Table 3 : Total quantity by product
        ...
        4. Insights :
             1. High Demand Product Types: Hat and Shoes have the highest quantities sold, indicating strong                                         customer demand for these categories. These high-demand categories make up 44.31% of total sales volume.
     ...
     - Pivot Table 4 : Total sales by Region
         ...
         Description: This pivot table shows total revenue by region, indicating the geographical performance of sales.
